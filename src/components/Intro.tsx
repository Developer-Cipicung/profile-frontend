    ...
    <section className="w-full bg-white px-5 py-14 sm:px-6 md:py-20 lg:px-8">
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[minmax(0,1fr)_480px] xl:grid-cols-[minmax(0,1fr)_540px]">
        <div className="min-w-0">
          <p className="text-sm font-bold uppercase text-hijau">Profil Desa</p>
          ...
          <div className="mt-6 max-w-3xl space-y-4 text-sm leading-7 text-[#4f6f5f] md:text-base md:leading-8">
            <p>
              ...
              di Daerah desa Cipicung 32 derajat celcius, sebagaimana desa-desa
              lain di Indonesia mempunyai Iklim Kemarau dan Iklim Penghujan.hal
              tersebut mempunyai mengaruh langsung terhadap pola Tanam yang ada
              di Desa Cipicung. Iklim suatu daerah sangat berpengaruh dalam
              kehidupan utamanya untuk pertumbuhan tanaman dan kelangsungan
              hidup. Selain itu, kondisi geografis desa Cipicung umumnya
        ...
        <div className="relative w-full">
          ...
          <div className="absolute -bottom-5 left-5 right-5 rounded-lg border border-emerald-100 bg-white px-5 py-4 shadow-[0_16px_32px_rgba(22,94,51,0.12)]">
            <p className="text-sm font-semibold text-hijau-tua">
              Kantor Desa Cipicung
            </p>
            <p className="mt-1 text-xs text-[#5A7A68]">
